...
public class Persoana extends Entity<Integer>{
    ...
    public Persoana(Integer integer, String nume, String prenume, String username, String parola, String ors, String strada, String nr_strada, String telefon) {
        setId(integer);
        this.nume = nume;
        ...
        TipuriOrase hob=null;
        if(ors.equals("Cluj")) {
            this.oras = oras.Cluj;
        }
        if(ors.equals("Sibiu")) {
            this.oras = oras.Sibiu;
        }
        if(ors.equals("Brasov")) {
            this.oras = oras.Brasov;
        }
